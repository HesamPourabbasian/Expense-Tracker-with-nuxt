...
- **نرخ‌های زنده ارز و طلا به ریال ایران**: نمایش لحظه‌ای قیمت دلار آمریکا، یورو، لیر ترکیه، تتر (USDT) و طلای ۱۸ عیار با درصد تغییرات ۲۴ ساعته، نشانگر نوسان و دکمه به‌روزرسانی دستی.
...
| **دفتر رمزارز و نرخ زنده ارز و طلا** | **ریال** (`ریال`) | قیمت‌های رمزارز و نرخ‌های زنده بازار به صورت ریال دقیق محاسبه و نمایش داده می‌شوند (همراه با معادل تومان). |
...
### نرخ‌های زنده بازار (Live Market Rates)
- `GET /api/market/prices` - دریافت قیمت‌های لحظه‌ای دلار آمریکا، یورو، لیر ترکیه، تتر (USDT) و هر گرم طلای ۱۸ عیار به ریال ایران همراه با درصد تغییرات ۲۴ ساعته
