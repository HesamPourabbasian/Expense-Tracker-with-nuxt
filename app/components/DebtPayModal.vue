        ...
        <div>
          ...
          <div class="space-y-2">
            ...
            <div v-if="accounts && accounts.length > 0" class="space-y-2">
              ...
              >
                <div class="flex items-center gap-3">
                  <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-white dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700 shadow-xs p-1.5">
                    <Icon :name="acc.icon || 'bank:general'" class="w-6 h-6 object-contain" />
                  </div>
                  <div>
                    <div class="flex items-center gap-2">
