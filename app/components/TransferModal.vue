    ...
    <div class="modal-panel max-w-lg">
      <div class="flex items-center justify-between mb-6">
        <div class="flex items-center gap-2.5">
          ...
          <div>
            <h2 class="text-base font-extrabold text-slate-900">مدیریت نقدینگی</h2>
      ...
      <form @submit.prevent="handleSubmit" class="space-y-4">
        ...
        <div v-if="!accounts || accounts.length < 2" class="bg-amber-50 border border-amber-200 text-amber-800 text-xs font-semibold rounded-xl p-3.5">
        ...
        <template v-else>
          ...
          <!-- Summary info note -->
          <div class="rounded-xl bg-slate-100/70 p-3 text-xs text-slate-500 font-medium">
            <p class="flex items-center gap-1.5 text-slate-700 font-bold mb-1">
